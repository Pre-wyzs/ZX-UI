	...
	<view class="uni-combox" :class="!border?'uni-combox__no-border':(showSelector?'uni-combox__selector-border':'') ">
		...
		<transition enter-active-class="animate__animated animate__bounceIn" leave-active-class="animate__animated animate__bounceOut">
			<view class="uni-combox__selector" v-if="showSelector">
				...
				<!-- <uni-transition ref="ani" :show="showSelector" custom-class="uni-combox__selector"> -->
...
<style lang="scss" scoped>
	...
	//选中的时候的边框颜色
	.uni-combox__selector-border {
		border-color: rgba(69, 185, 132, .5);
		box-shadow: 0 0 0 2px rgba(69, 185, 132, .2);
	}
